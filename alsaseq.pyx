...
cdef extern from 'alsa/asoundlib.h':
    ...
    int SND_SEQ_EVENT_SAMPLE
    int SND_SEQ_EVENT_SAMPLE_CLUSTER
    int SND_SEQ_EVENT_SAMPLE_START
    int SND_SEQ_EVENT_SAMPLE_STOP
    int SND_SEQ_EVENT_SAMPLE_FREQ
    int SND_SEQ_EVENT_SAMPLE_VOLUME
    int SND_SEQ_EVENT_SAMPLE_LOOP
    int SND_SEQ_EVENT_SAMPLE_POSITION
    int SND_SEQ_EVENT_SAMPLE_PRIVATE1
    ...
    int SND_SEQ_EVENT_INSTR_BEGIN
    int SND_SEQ_EVENT_INSTR_END
    int SND_SEQ_EVENT_INSTR_INFO
    int SND_SEQ_EVENT_INSTR_INFO_RESULT
    int SND_SEQ_EVENT_INSTR_FINFO
    int SND_SEQ_EVENT_INSTR_FINFO_RESULT
    int SND_SEQ_EVENT_INSTR_RESET
    int SND_SEQ_EVENT_INSTR_STATUS
    int SND_SEQ_EVENT_INSTR_STATUS_RESULT
    int SND_SEQ_EVENT_INSTR_PUT
    int SND_SEQ_EVENT_INSTR_GET
    int SND_SEQ_EVENT_INSTR_GET_RESULT
    int SND_SEQ_EVENT_INSTR_FREE
    int SND_SEQ_EVENT_INSTR_LIST
    int SND_SEQ_EVENT_INSTR_LIST_RESULT
    int SND_SEQ_EVENT_INSTR_CLUSTER
    int SND_SEQ_EVENT_INSTR_CLUSTER_GET
    int SND_SEQ_EVENT_INSTR_CLUSTER_RESULT
    int SND_SEQ_EVENT_INSTR_CHANGE
...
eventTypeNames = {
    ...
    SND_SEQ_EVENT_SAMPLE_CLUSTER: 'SAMPLE_CLUSTER',
    SND_SEQ_EVENT_SAMPLE_START: 'SAMPLE_START',
    SND_SEQ_EVENT_SAMPLE_STOP: 'SAMPLE_STOP',
    SND_SEQ_EVENT_SAMPLE_FREQ: 'SAMPLE_FREQ',
    SND_SEQ_EVENT_SAMPLE_VOLUME: 'SAMPLE_VOLUME',
    SND_SEQ_EVENT_SAMPLE_LOOP: 'SAMPLE_LOOP',
    SND_SEQ_EVENT_SAMPLE_POSITION: 'SAMPLE_POSITION',
    SND_SEQ_EVENT_SAMPLE_PRIVATE1: 'SAMPLE_PRIVATE1',
    ...
    SND_SEQ_EVENT_INSTR_BEGIN: 'INSTR_BEGIN',
    SND_SEQ_EVENT_INSTR_END: 'INSTR_END',
    SND_SEQ_EVENT_INSTR_INFO: 'INSTR_INFO',
    SND_SEQ_EVENT_INSTR_INFO_RESULT: 'INSTR_INFO_RESULT',
    SND_SEQ_EVENT_INSTR_FINFO: 'INSTR_FINFO',
    SND_SEQ_EVENT_INSTR_FINFO_RESULT: 'INSTR_FINFO_RESULT',
    SND_SEQ_EVENT_INSTR_RESET: 'INSTR_RESET',
    SND_SEQ_EVENT_INSTR_STATUS: 'INSTR_STATUS',
    SND_SEQ_EVENT_INSTR_STATUS_RESULT: 'INSTR_STATUS_RESULT',
    SND_SEQ_EVENT_INSTR_PUT: 'INSTR_PUT',
    SND_SEQ_EVENT_INSTR_GET: 'INSTR_GET',
    SND_SEQ_EVENT_INSTR_GET_RESULT: 'INSTR_GET_RESULT',
    SND_SEQ_EVENT_INSTR_FREE: 'INSTR_FREE',
    SND_SEQ_EVENT_INSTR_LIST: 'INSTR_LIST',
    SND_SEQ_EVENT_INSTR_LIST_RESULT: 'INSTR_LIST_RESULT',
    SND_SEQ_EVENT_INSTR_CLUSTER: 'INSTR_CLUSTER',
    SND_SEQ_EVENT_INSTR_CLUSTER_GET: 'INSTR_CLUSTER_GET',
    SND_SEQ_EVENT_INSTR_CLUSTER_RESULT: 'INSTR_CLUSTER_RESULT',
    SND_SEQ_EVENT_INSTR_CHANGE: 'INSTR_CHANGE',
